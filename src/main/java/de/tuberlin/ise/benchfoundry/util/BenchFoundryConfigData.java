		...
		while ((line = br.readLine()) != null) {
			...
			case "custparamFilename":
				...
				if (custparamFilename.equalsIgnoreCase("none")) {
					...
					IOUtils.writeFile("custparam.tmp", "#dummy content generated by BenchFoundry\n-1:-1".getBytes());
			...
			case "preloadTraceFilename":
				...
				if (traceFilenamePreload.equalsIgnoreCase("none")) {
					...
					IOUtils.writeFile("preload.tmp", "#dummy content generated by BenchFoundry".getBytes());
			...
			case "warmupTraceFilename":
				...
				if (traceFilenameWarmup.equalsIgnoreCase("none")) {
					...
					IOUtils.writeFile("warmup.tmp", "#dummy content generated by BenchFoundry".getBytes());
