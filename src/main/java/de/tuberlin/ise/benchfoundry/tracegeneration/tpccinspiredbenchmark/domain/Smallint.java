...
public class Smallint extends Domain {
	...
	public Smallint(boolean unique, boolean unsigned, boolean zerofill) {
		super(unique);
		leased = new HashMap<>();
		if (unsigned) {
			this.unsigned = true;
	...
	public String getName() {
		return Smallint.class.getName().toUpperCase();
	}
	...
	public String nextInsertField() {
		if (super.unique) {
			...
			if (unsigned)
				return String.valueOf(generator.nextInt(65535));
			else
				return String.valueOf(generator.nextInt(65535) - 32768);
		}
	}
